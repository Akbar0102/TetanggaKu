...
public class OpenHelper extends SQLiteOpenHelper {
    ...
    public static final String TABLE_WARGA =
            "CREATE TABLE `table_warga` ( `id_warga` INTEGER PRIMARY KEY, `nik` TEXT," +
    ...
    public static final String TABLE_USER =
            "CREATE TABLE \"table_user\" ( `id_user` INTEGER PRIMARY KEY," +
    ...
    public static final String TABLE_USAHA_WARGA =
            "CREATE TABLE `table_usaha_warga` ( `id` INTEGER PRIMARY KEY, `nama_usaha` TEXT,"+
            "`nama_pemilik` TEXT, `alamat` TEXT, `latitude` REAL, `longitude` REAL )";
    public static final String TABLE_POI =
            "CREATE TABLE `table_poi` ( `id` INTEGER PRIMARY KEY, `nama_tempat` TEXT, `alamat` TEXT, `tipe_tempat` TEXT, `latitude` REAL, `longitude` REAL )";
    public static final String TABLE_FORUM =
            "CREATE TABLE \"table_forum\" ( `id_status` INTEGER PRIMARY KEY, `id_warga` INTEGER," +
    ...
    public static final String TABLE_EVENT =
            "CREATE TABLE \"table_event\" ( `id_event` INTEGER PRIMARY KEY , `nama_event` TEXT," +
            "`alamat` TEXT, `tanggal_mulai` INTEGER, `deskripsi` TEXT, `id_warga` INTEGER," +
            "`latitude` REAL, `longitude` REAL, FOREIGN KEY(`id_warga`) REFERENCES `table_warga`(`id_warga`) ON DELETE SET NULL )";
    public static final String TABLE_KOMENTAR = "CREATE TABLE `table_komentar` ( `id_komen` INTEGER PRIMARY KEY,"+
