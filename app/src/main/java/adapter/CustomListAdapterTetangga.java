...
public class CustomListAdapterTetangga extends ArrayAdapter<Warga> {
    private Context context;
    private ArrayList<Warga> warga;

    public CustomListAdapterTetangga(Context context, int resource, ArrayList<Warga> warga){
    ...
    public View getView(int position, View view, ViewGroup parent){
        ...
        View rowView = inflater.inflate(R.layout.custom_list_tetangga, null, true);
